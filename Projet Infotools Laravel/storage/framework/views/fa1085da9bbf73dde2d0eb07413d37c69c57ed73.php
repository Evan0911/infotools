...
<!-- partie prospect -->
    <?php if(Auth::user()->is_admin == 0): ?>
        ...
        <?php $__currentLoopData = $rdvs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rdv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(isset($rdv)): ?>
                <?php if($rdv->user->idUser == Auth::id()): ?>
                    <tr>
                        <td><?php echo e($rdv->id); ?></td>
                        <td><?php echo e($rdv->client->nomCli . " " . $rdv->client->prenomCli); ?></td>
                        <td><?php echo e($rdv->user->nomPros . " " . $rdv->user->prenomPros . "idUser = " . $rdv->user->idUser . "Auth id =" . Auth::id()); ?></td>
                        ...
                        <td>
                            ...
                            <!--
                            <?php echo Form::open(['method' => 'DELETE','route' => ['rdvs.destroy', $rdv->id],'style'=>'display:inline']); ?>
        ...
        <tr>
            ...
            <td>
                ...
                <!-- y manque un form mit dans Backup Code -->
    ...
    <?php else: ?>
        ...
        <tr>
            ...
            <td>
                ...
                <!--<?php echo Form::open(['method' => 'DELETE','route' => ['clients.destroy', $client->id],'style'=>'display:inline']); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alexa\source\repos\InfoTools\resources\views/clients/index.blade.php ENDPATH**/ ?>